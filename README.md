...
We will go over-
1. [A Crash course on VLSI Design Flow:.] ([## A Crash course on VLSI Design Flow:](https://github.com/Komal-design-vlsi/VSD-SOC_DESIGN_AND_Planning#vsd-soc_design_and_planning)
2. [Exploring OPENLANE- Getting familiar with the tool](https://github.com/Komal-design-vlsi/VSD-SOC_DESIGN_AND_Planning#exploring-openlane--getting-familiar-with-the-tool)
3. [Characterizing a standard cell](https://github.com/Komal-design-vlsi/VSD-SOC_DESIGN_AND_Planning#3-characterizing-a-standard-cell)
...
5. Running the Backend Flow on the example design merged with the standard cell
   - [Synthesis] (https://github.com/Komal-design-vlsi/VSD-SOC_DESIGN_AND_Planning#run-synthesis-after-adding-the-inverter)
   - Timing Analysis on Synthesis Netlist
   - [floorplan](https://github.com/Komal-design-vlsi/VSD-SOC_DESIGN_AND_Planning#floorplan)
   - [Placement ](https://github.com/Komal-design-vlsi/VSD-SOC_DESIGN_AND_Planning/blob/22c479389c3b11df72f7a73a23fda52d0b605793/README.md?plain=1#L170)
   - Timing Analysis on Placement Netlist
   - [Clock Tree Synthesis](https://github.com/Komal-design-vlsi/VSD-SOC_DESIGN_AND_Planning#run_cts)
   - Timing Analysis on Clock Tree Synthesis Netlist
   - [PDN](https://github.com/Komal-design-vlsi/VSD-SOC_DESIGN_AND_Planning#pdn)
   - [Routing](https://github.com/Komal-design-vlsi/VSD-SOC_DESIGN_AND_Planning#routing)
